...
class Media:
    ...
    def __init__(self, json=None, title="No Title", author="No Author", release_year="No Release Year", url='No URL'):
        self.json = json
...
class Song(Media):
    def __init__(self, json=None, title="No Title", author="No Author", release_year="No Release Year", url='No URL', album="No Album", genre="No Genre", track_length= 0):
...
class Movie(Media):
    def __init__(self, json=None, title="No Title", author="No Author", release_year="No Release Year", url='No URL', rating="No Rating", movie_length=0):
...
if __name__ == "__main__":
    ...
    def itune_interface(enter):
        if enter == 'exit':
            ...
            #text = response.text
            results_object = json.loads(response)  # dict
