...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        '''
        d2 = HW_cards.Deck()
        self.assertIsInstance(d2.deal_card(), HW_cards.Card)  
        #! HW_cards.Card is a class
        
        return d2.deal_card(), HW_cards.Card
    ...
    def test_q7(self):
        ...
        '''
        d4 = HW_cards.Deck() #creat instacne
        
        top_card = d4.cards[-1]
        d4.deal_card()
        d4.replace_card(top_card)  #replace the same card back
    
        self.assertTrue(len(d4.cards), 52)  
    ...
    def test_q8(self):
        ...
        #! the deck size is not affected == still 52
        
        top_card = d5.cards[-1]
        d5.replace_card(top_card)
