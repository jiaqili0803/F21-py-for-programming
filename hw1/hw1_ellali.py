...
% Student Name: Jiaqi Li

% Student Unique Name: ellali
...
def make_move(player, board):  
    ...
    while True:
        move = input()
        print(str(player_name(player))+'\'s move: '+str(move))
...
def check_win_horizontal(board):
    ...
    '''check if player X or O has won in horizontal way
    ...
    Returns
    -------
    the the id of the player who win in horizontal way
    '''
    if (board[0] != 0 and 
        board[0] == board[1] and 
        board[0] == board[2]):
...
def check_win_vertical(board):
    ...
    '''check if player X or O has won in vertical way
    ...
    Returns
    -------
    the the id of the player who win in vertical way
    '''
    if (board[0] != 0 and 
        board[0] == board[3] and 
        board[0] == board[6]):
...
def check_win_diagonal(board):
    # TODO: write docstring
    # TODO: implement function
    '''check if player X or O has won in diagonal way
    ...
    Returns
    -------
    the the id of the player who win in diagonal way
    '''
    if (board[0] != 0 and 
        board[0] == board[4] and 
        board[0] == board[8]):
...
if __name__=="__main__": # this line has been added to make the autograder run. Please note TODOs below!!
    ...
    display_board(board)   
    print('Game over! '+ str(player_name(winner)) +' wins!')

    # This level of indentation is purposeful.
